2024-08-01 Thu: Migrated 1Bot database to Soph's new cluster, updating PKs, FKs, Indexes, sequences, and data to match the old DB cluster. Next day's plan: monitor 1Bot/DB integration. For Vertex Defi App frontend, accessed Trade menu page locally after modifying components using TradingView mock data.
