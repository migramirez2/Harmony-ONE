2024-10-08 Tue: [Updated](https://github.com/sunwavesun/account-abstraction) the account-abstraction to deploy `EntryPoint.sol` to utilize Safe's [Singleton Factory](https://github.com/safe-global/safe-singleton-factory) in order to use EIP-155 transactions. In other networks (except EIP-155 enforced ones such as Harmony, Celo, Avalance), the address for `EntryPoint.sol` is identical but since Harmony requires to utilize a different deterministic deployment approach, it will be different but consistent throughout our networks (address: 0xa2D7Ee364463d38d03B858Ea126d28C3F3199973; tx: 0x8a38db387c39aa90bcd0a634e461aedb17029dae4d1f989faa4c42ed465f15a1). It is currently deployed in Testnet and will be deployed to Mainnet once the Bundler node is working as expected.
