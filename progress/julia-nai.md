2023-03-11 Mon: Reading wav2vec experiments with extra unlabeled training data and the impact on model performance. Looking into Whisper training set and finding correlation between data in and data out. 
